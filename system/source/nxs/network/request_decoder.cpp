...
namespace nds
{
    ...
    void encoder<>::decode(const std::string& str_request, nxs::request& req)
    {
        ...
        if (request_end == std::string::npos) nxs_error << "end of request not found" << str_request << nxs::log::network;
...
////////////////////////////////////////////////////////////////////////////////
        ...
        } catch (const std::exception& e) { nxs_error << "header decode error :" << e.what() << nxs::log::system; }
    }
} // nds
